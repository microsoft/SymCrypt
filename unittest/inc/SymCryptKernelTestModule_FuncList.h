...
FUNCTION(SymCryptCompositeMlDsakeyAllocate)
FUNCTION(SymCryptCompositeMlDsakeyFree)
FUNCTION(SymCryptCompositeMlDsakeyGenerate)
FUNCTION(SymCryptCompositeMlDsakeyGetValue)
FUNCTION(SymCryptCompositeMlDsakeySetValue)
FUNCTION(SymCryptCompositeMlDsaSign)
FUNCTION(SymCryptCompositeMlDsaSizeofKeyFormatFromParams)
FUNCTION(SymCryptCompositeMlDsaSizeofSignatureFromParams)
FUNCTION(SymCryptCompositeMlDsaVerify)
FUNCTION(SymCryptCompositeMlKemDecapsulate)
FUNCTION(SymCryptCompositeMlKemEncapsulate)
FUNCTION(SymCryptCompositeMlKemEncapsulateEx)
FUNCTION(SymCryptCompositeMlKemkeyAllocate)
FUNCTION(SymCryptCompositeMlKemkeyFree)
FUNCTION(SymCryptCompositeMlKemkeyGenerate)
FUNCTION(SymCryptCompositeMlKemkeyGetValue)
FUNCTION(SymCryptCompositeMlKemkeySetValue)
FUNCTION(SymCryptCompositeMlKemSizeofCiphertextFromParams)
FUNCTION(SymCryptCompositeMlKemSizeofKeyFormatFromParams)
...
FUNCTION(SymCryptDeprecatedServiceIndicator)
...
FUNCTION(SymCryptExternalMuMlDsaSign)
FUNCTION(SymCryptExternalMuMlDsaVerify)
...
FUNCTION(SymCryptHashMlDsaSign)
FUNCTION(SymCryptHashMlDsaVerify)
...
FUNCTION(SymCryptMlDsakeyAllocate)
FUNCTION(SymCryptMlDsakeyFree)
FUNCTION(SymCryptMlDsakeyGenerate)
FUNCTION(SymCryptMlDsakeyGetValue)
FUNCTION(SymCryptMlDsakeySetValue)
FUNCTION(SymCryptMlDsaSelftest)
FUNCTION(SymCryptMlDsaSign)
FUNCTION(SymCryptMlDsaSizeofKeyFormatFromParams)
FUNCTION(SymCryptMlDsaSizeofSignatureFromParams)
FUNCTION(SymCryptMlDsaVerify)
...
FUNCTION(SymCryptShake128StateExport)
FUNCTION(SymCryptShake128StateImport)
...
FUNCTION(SymCryptShake256StateExport)
FUNCTION(SymCryptShake256StateImport)
