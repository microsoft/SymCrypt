...
#define SYMCRYPT_MLKEM_DRAFT203_512_PARAMS_NAME  "ML-KEM-DRAFT203-512"
#define SYMCRYPT_MLKEM_DRAFT203_768_PARAMS_NAME  "ML-KEM-DRAFT203-768"
#define SYMCRYPT_MLKEM_DRAFT203_1024_PARAMS_NAME "ML-KEM-DRAFT203-1024"
...
SYMCRYPT_TEST_MLKEM_PARAMS rgTestMlKemParams[] = {
    //pszParamsName                     //pParams
    { SYMCRYPT_MLKEM_DRAFT203_512_PARAMS_NAME,   SymCryptMlKemParamsDraft203MlKem512  },
    { SYMCRYPT_MLKEM_DRAFT203_768_PARAMS_NAME,   SymCryptMlKemParamsDraft203MlKem768  },
    { SYMCRYPT_MLKEM_DRAFT203_1024_PARAMS_NAME,  SymCryptMlKemParamsDraft203MlKem1024 },
};
...
testMlKemHighLevelAPI()
{
    ...
    {
        PCSYMCRYPT_MLKEM_PARAMS params = testParams.pParams;

        keyTestBlobFull.type   = (SYMCRYPT_MLKEM_TYPE)params->type;
        keyTestBlobDecaps.type = (SYMCRYPT_MLKEM_TYPE)params->type;
        keyTestBlobEncaps.type = (SYMCRYPT_MLKEM_TYPE)params->type;
        ...
        ULONGLONG               line )
{
    ...
    keyTestBlob.type = (SYMCRYPT_MLKEM_TYPE)pParams->type;
...
testKemKats()
{
    ...
    while( 1 )
    {
        ...
        if( katItem.type == KAT_TYPE_CATEGORY )
        {
            ...
            pParams = rgTestMlKemParams[i].pParams;
        }
