//
// Pattern file for the CNG TLS PRF 1.1 implementations.
//
                            ...
                            SIZE_T          cbDst)
{
    ...
    // TLS PRF 1.1 ignores the base hash method, only need label and seed
    ...
    ULONG cbResult;
    CHECK(NT_SUCCESS((*CngKeyDerivationFn)(hKey, &bufferDesc, pbDst, (ULONG)cbDst, &cbResult, 0)), "Failure in CNG TLS PRF 1.1 call");
