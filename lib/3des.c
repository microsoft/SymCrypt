...
extern __declspec( align(256) ) const UINT32 SymCryptDesSpbox[8][64];      // Combined S and P tables
extern __declspec( align(256) ) const UINT32 SymCryptDesKeySelect[8][64];
