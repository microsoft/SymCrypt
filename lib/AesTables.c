...
//
__declspec(align(1024)) const BYTE SymCryptAesSboxMatrixMult[4][256][4] = {{   // Main encryption tables
...
__declspec(align(1024)) const BYTE SymCryptAesInvSboxMatrixMult[4][256][4] = {{// Main decryption tables
...
__declspec(align(1024)) const BYTE SymCryptAesInvMatrixMult[4][256][4] = {{    // For computing decryption round keys
...
__declspec(align(256)) const BYTE SymCryptAesSbox[256] = { 
...
__declspec(align(256)) const BYTE SymCryptAesInvSbox[256] = {                // For final round in decryption
0x52,0x09,0x6a,0xd5,
0x30,0x36,0xa5,0x38,
0xbf,0x40,0xa3,0x9e,
0x81,0xf3,0xd7,0xfb,
