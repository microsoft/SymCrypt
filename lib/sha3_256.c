...
{
    SymCryptSha3StateExport(SymCryptBlobTypeSha3_256State, pState, pbBlob);
}
...
{
    return SymCryptSha3StateImport(SymCryptBlobTypeSha3_256State, pState, pbBlob);
}
