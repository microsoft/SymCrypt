...
static const SYMCRYPT_SI_ALG_DATA _Cipher[] = {
    {
        ...
        SYMCRYPT_SI_AES_CTR | SYMCRYPT_SI_AES_ECB | SYMCRYPT_SI_AES_GCM | SYMCRYPT_SI_AES_KW |
        SYMCRYPT_SI_AES_KWP,
...
static const SYMCRYPT_SI_ALG_DATA _Kdf[] = {
...

    {
        ...
        SYMCRYPT_SI_PARAM2(
            SYMCRYPT_SI_HMAC_SHA1 | \
            SYMCRYPT_SI_HMAC_SHA2_224 | SYMCRYPT_SI_HMAC_SHA2_256 | SYMCRYPT_SI_HMAC_SHA2_384 | SYMCRYPT_SI_HMAC_SHA2_512 | \
            SYMCRYPT_SI_HMAC_SHA2_512_224 | SYMCRYPT_SI_HMAC_SHA2_512_256 | \
            SYMCRYPT_SI_HMAC_SHA3_224 |SYMCRYPT_SI_HMAC_SHA3_256 | SYMCRYPT_SI_HMAC_SHA3_384 | SYMCRYPT_SI_HMAC_SHA3_512,
            SYMCRYPT_SI_SIZE_GTE(112)
        )
    },
