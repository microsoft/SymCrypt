...
#define SYMCRYPT_SELFTEST_RSAKEY_BITS 2048
...
SymCryptRsaPairwiseSelftest()
{
    ...
    BYTE rbSignature[SYMCRYPT_SELFTEST_RSAKEY_BITS / 8] = {0};
    SIZE_T cbSignature = sizeof(rbSignature);

    rsaParams.version = 1;
    rsaParams.nBitsOfModulus = ((UINT32) SYMCRYPT_SELFTEST_RSAKEY_BITS );
    rsaParams.nPrimes = 2;
    rsaParams.nPubExp = 1;
